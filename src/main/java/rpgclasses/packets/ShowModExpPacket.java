...
public class ShowModExpPacket extends Packet {
    ...
    public void processClient(NetworkPacket packet, Client client) {
        if (exp != 0) {
            FloatTextFade text = new FloatTextFade(x, y - 20, (exp > 0 ? "+" + exp : exp) + " " + Localization.translate("message", "xp") + (levelUp ? " - " + Localization.translate("message", "levelup") : ""), (new FontOptions(16)).outline().color(exp > 0 ? new Color(100, 200, 100) : new Color(200, 100, 100))) {
